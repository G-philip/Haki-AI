...
export default function ChatArea({ messages, documentText, docType, collectedFields, downloadDoc, chatEndRef, stage, newChat, thinking, loading, onRetry, onEdit }) {
  ...
  return (
    <>
      ...
      */}
      <div className="max-w-[720px] mx-auto px-6 py-8 pb-32">
          {visibleMessages.map((msg) => {
            ...
            return (
              <div key={realIndex} className="my-2">
                <div className="text-black font-semibold py-2 text-[15px] leading-relaxed whitespace-pre-wrap break-words">
                  {msg.content}
                </div>
              </div>
            )
          ...
          {documentText && (
            <div className="mt-6">
              <h3 className="text-base font-normal text-gray-400 mb-3">Generated Document</h3>
